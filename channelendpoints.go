...
func newChannelEndpoints(rootSDK *Novu, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ChannelEndpoints {
...
func (s *ChannelEndpoints) List(ctx context.Context, request operations.ChannelEndpointsControllerListChannelEndpointsRequest, opts ...operations.Option) (*operations.ChannelEndpointsControllerListChannelEndpointsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v1/channel-endpoints")
	if err != nil {
	...
	res := &operations.ChannelEndpointsControllerListChannelEndpointsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ListChannelEndpointsResponseDto
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListChannelEndpointsResponseDto = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *ChannelEndpoints) Create(ctx context.Context, requestBody operations.ChannelEndpointsControllerCreateChannelEndpointRequestBody, idempotencyKey *string, opts ...operations.Option) (*operations.ChannelEndpointsControllerCreateChannelEndpointResponse, error) {
	...
	res := &operations.ChannelEndpointsControllerCreateChannelEndpointResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetChannelEndpointResponseDto
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetChannelEndpointResponseDto = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *ChannelEndpoints) Retrieve(ctx context.Context, identifier string, idempotencyKey *string, opts ...operations.Option) (*operations.ChannelEndpointsControllerGetChannelEndpointResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/channel-endpoints/{identifier}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ChannelEndpointsControllerGetChannelEndpointResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *ChannelEndpoints) Update(ctx context.Context, identifier string, updateChannelEndpointRequestDto components.UpdateChannelEndpointRequestDto, idempotencyKey *string, opts ...operations.Option) (*operations.ChannelEndpointsControllerUpdateChannelEndpointResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "UpdateChannelEndpointRequestDto", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.ChannelEndpointsControllerUpdateChannelEndpointResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *ChannelEndpoints) Delete(ctx context.Context, identifier string, idempotencyKey *string, opts ...operations.Option) (*operations.ChannelEndpointsControllerDeleteChannelEndpointResponse, error) {
	...
	res := &operations.ChannelEndpointsControllerDeleteChannelEndpointResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
