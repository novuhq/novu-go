...
func (s *TopicsSubscribers) Add(ctx context.Context, topicKey string, addSubscribersRequestDto components.AddSubscribersRequestDto, opts ...operations.Option) (*operations.TopicsControllerAssignResponse, error) {
