...
type TopicsSubscribers struct {
	sdkConfiguration sdkConfiguration
}

func newTopicsSubscribers(sdkConfig sdkConfiguration) *TopicsSubscribers {
...
func (s *TopicsSubscribers) Add(ctx context.Context, topicKey string, addSubscribersRequestDto components.AddSubscribersRequestDto, idempotencyKey *string, opts ...operations.Option) (*operations.TopicsControllerAssignResponse, error) {
