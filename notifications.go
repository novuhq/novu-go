...
// Get notification
func (s *Notifications) Get(ctx context.Context, notificationID string, opts ...operations.Option) (*operations.NotificationsControllerGetNotificationResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
