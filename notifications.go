...
func newNotifications(rootSDK *Novu, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Notifications {
...
func (s *Notifications) List(ctx context.Context, request operations.NotificationsControllerListNotificationsRequest, opts ...operations.Option) (*operations.NotificationsControllerListNotificationsResponse, error) {
	...
	res := &operations.NotificationsControllerListNotificationsResponse{
...
func (s *Notifications) Retrieve(ctx context.Context, notificationID string, idempotencyKey *string, opts ...operations.Option) (*operations.NotificationsControllerGetNotificationResponse, error) {
	...
	res := &operations.NotificationsControllerGetNotificationResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ActivityNotificationResponseDto
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ActivityNotificationResponseDto = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
