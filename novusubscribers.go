...
func newNovuSubscribers(sdkConfig sdkConfiguration) *NovuSubscribers {
...
func (s *NovuSubscribers) Assign(ctx context.Context, topicKey string, addSubscribersRequestDto components.AddSubscribersRequestDto, idempotencyKey *string, opts ...operations.Option) (*operations.TopicsControllerAssignResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/topics/{topicKey}/subscribers", request, nil)
	if err != nil {
	...
	res := &operations.TopicsControllerAssignResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.AssignSubscriberToTopicDto
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AssignSubscriberToTopicDto = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
