...
func newNovuSubscribers(rootSDK *Novu, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *NovuSubscribers {
	return &NovuSubscribers{
		rootSDK:          rootSDK,
...
func (s *NovuSubscribers) Retrieve(ctx context.Context, externalSubscriberID string, topicKey string, idempotencyKey *string, opts ...operations.Option) (*operations.TopicsV1ControllerGetTopicSubscriberResponse, error) {
	request := operations.TopicsV1ControllerGetTopicSubscriberRequest{
	...
	res := &operations.TopicsV1ControllerGetTopicSubscriberResponse{
