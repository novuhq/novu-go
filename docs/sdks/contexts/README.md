...
* [List](#list) - List contexts
* [Update](#update) - Update context data
* [Retrieve](#retrieve) - Get context by id
* [Delete](#delete) - Delete context
...
func main() {
    ...
    res, err := s.Contexts.List(ctx, operations.ContextsControllerListContextsRequest{
        ID: novugo.Pointer("tenant-prod-123"),
        Search: novugo.Pointer("tenant"),
    })
    if err != nil {
        log.Fatal(err)
    }
