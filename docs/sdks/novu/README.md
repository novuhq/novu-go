...
func main() {
    ...
    res, err := s.Retrieve(ctx, operations.LogsControllerGetLogsRequest{})
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
**[*operations.LogsControllerGetLogsResponse](../../models/operations/logscontrollergetlogsresponse.md), error**
