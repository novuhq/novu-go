...
func (s *Integrations) IntegrationsControllerAutoConfigureIntegration(ctx context.Context, integrationID string, idempotencyKey *string, opts ...operations.Option) (*operations.IntegrationsControllerAutoConfigureIntegrationResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/integrations/{integrationId}/auto-configure", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.IntegrationsControllerAutoConfigureIntegrationResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.AutoConfigureIntegrationResponseDto
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AutoConfigureIntegrationResponseDto = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Integrations) CreateMobileLink(ctx context.Context, integrationIdentifier string, issueIntegrationMobileLinkRequestDto components.IssueIntegrationMobileLinkRequestDto, idempotencyKey *string, opts ...operations.Option) (*operations.IntegrationsControllerCreateIntegrationMobileLinkResponse, error) {
	request := operations.IntegrationsControllerCreateIntegrationMobileLinkRequest{
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/integrations/{integrationIdentifier}/mobile-link", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "IssueIntegrationMobileLinkRequestDto", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.IntegrationsControllerCreateIntegrationMobileLinkResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.IssueTelegramMobileLinkResponseDto
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.IssueTelegramMobileLinkResponseDto = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Integrations) IntegrationsControllerConfigureIntegrationWebhook(ctx context.Context, integrationIdentifier string, idempotencyKey *string, opts ...operations.Option) (*operations.IntegrationsControllerConfigureIntegrationWebhookResponse, error) {
	request := operations.IntegrationsControllerConfigureIntegrationWebhookRequest{
		IntegrationIdentifier: integrationIdentifier,
		IdempotencyKey:        idempotencyKey,
	}
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/integrations/{integrationIdentifier}/webhook/configure", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.IntegrationsControllerConfigureIntegrationWebhookResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ConfigureTelegramWebhookResponseDto
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ConfigureTelegramWebhookResponseDto = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Integrations) GenerateConnectOAuthURL(ctx context.Context, generateConnectOauthURLRequestDto components.GenerateConnectOauthURLRequestDto, idempotencyKey *string, opts ...operations.Option) (*operations.IntegrationsControllerGenerateConnectOAuthURLResponse, error) {
	request := operations.IntegrationsControllerGenerateConnectOAuthURLRequest{
		IdempotencyKey:                    idempotencyKey,
	...
	opURL, err := url.JoinPath(baseURL, "/v1/integrations/channel-connections/oauth")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "GenerateConnectOauthURLRequestDto", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.IntegrationsControllerGenerateConnectOAuthURLResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GenerateChatOAuthURLResponseDto
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GenerateChatOAuthURLResponseDto = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Integrations) LinkChannelEndpoint(ctx context.Context, linkChannelEndpointRequestDto components.LinkChannelEndpointRequestDto, idempotencyKey *string, opts ...operations.Option) (*operations.IntegrationsControllerLinkChannelEndpointResponse, error) {
	request := operations.IntegrationsControllerLinkChannelEndpointRequest{
		IdempotencyKey:                idempotencyKey,
	...
	opURL, err := url.JoinPath(baseURL, "/v1/integrations/channel-endpoints/link")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "LinkChannelEndpointRequestDto", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.IntegrationsControllerLinkChannelEndpointResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.LinkChannelEndpointResponseDto
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.LinkChannelEndpointResponseDto = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Integrations) GenerateLinkUserOAuthURL(ctx context.Context, generateLinkUserOauthURLRequestDto components.GenerateLinkUserOauthURLRequestDto, idempotencyKey *string, opts ...operations.Option) (*operations.IntegrationsControllerGenerateLinkUserOAuthURLResponse, error) {
	request := operations.IntegrationsControllerGenerateLinkUserOAuthURLRequest{
		IdempotencyKey:                     idempotencyKey,
	...
	opURL, err := url.JoinPath(baseURL, "/v1/integrations/channel-endpoints/oauth")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "GenerateLinkUserOauthURLRequestDto", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.IntegrationsControllerGenerateLinkUserOAuthURLResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Integrations) GenerateChatOAuthURL(ctx context.Context, generateChatOauthURLRequestDto components.GenerateChatOauthURLRequestDto, idempotencyKey *string, opts ...operations.Option) (*operations.IntegrationsControllerGetChatOAuthURLResponse, error) {
	request := operations.IntegrationsControllerGetChatOAuthURLRequest{
		IdempotencyKey:                 idempotencyKey,
	...
	opURL, err := url.JoinPath(baseURL, "/v1/integrations/chat/oauth")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "GenerateChatOauthURLRequestDto", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.IntegrationsControllerGetChatOAuthURLResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
