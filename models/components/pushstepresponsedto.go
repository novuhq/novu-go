...
func (p *PushStepResponseDto) GetProviderOverrides() map[string]map[string]any {
	if p == nil {
		return nil
	}
	return p.ProviderOverrides
}
...
func (p *PushStepResponseDto) GetStepResolverHash() *string {
	if p == nil {
		return nil
	}
	return p.StepResolverHash
}
