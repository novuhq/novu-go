...
func (d DigestStepUpsertDto) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DigestStepUpsertDto) UnmarshalJSON(data []byte) error {
...
func (d *DigestStepUpsertDto) GetID() *string {
	if d == nil {
		return nil
	}
	return d.ID
...
func (d *DigestStepUpsertDto) GetType() StepTypeEnum {
	if d == nil {
		return StepTypeEnum("")
	}
	return d.Type
...
func (d *DigestStepUpsertDto) GetControlValues() *DigestStepUpsertDtoControlValues {
	if d == nil {
		return nil
	}
