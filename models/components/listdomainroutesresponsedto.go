...
type ListDomainRoutesResponseDto struct {
	...
	Data []DomainRouteResponseDto `json:"data"`
...
func (l *ListDomainRoutesResponseDto) GetData() []DomainRouteResponseDto {
	if l == nil {
		return []DomainRouteResponseDto{}
	}
	return l.Data
}

func (l *ListDomainRoutesResponseDto) GetNext() *string {
	if l == nil {
		return nil
	}
	return l.Next
...
func (l *ListDomainRoutesResponseDto) GetPrevious() *string {
	if l == nil {
		return nil
	}
	return l.Previous
...
func (l *ListDomainRoutesResponseDto) GetTotalCount() float64 {
	if l == nil {
		return 0.0
	}
	return l.TotalCount
...
func (l *ListDomainRoutesResponseDto) GetTotalCountCapped() bool {
	if l == nil {
		return false
	}
