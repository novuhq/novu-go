...
func (i *InAppStepResponseDto) GetProviderOverrides() map[string]map[string]any {
	if i == nil {
		return nil
	}
	return i.ProviderOverrides
}
...
func (i *InAppStepResponseDto) GetStepResolverHash() *string {
	if i == nil {
		return nil
	}
	return i.StepResolverHash
}
