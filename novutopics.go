...
func newNovuTopics(rootSDK *Novu, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *NovuTopics {
	return &NovuTopics{
		rootSDK:          rootSDK,
...
func (s *NovuTopics) List(ctx context.Context, request operations.SubscribersControllerListSubscriberTopicsRequest, opts ...operations.Option) (*operations.SubscribersControllerListSubscriberTopicsResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/subscribers/{subscriberId}/subscriptions", request, nil)
	if err != nil {
	...
	res := &operations.SubscribersControllerListSubscriberTopicsResponse{
