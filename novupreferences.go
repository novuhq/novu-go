...
type NovuPreferences struct {
	sdkConfiguration sdkConfiguration
}

func newNovuPreferences(sdkConfig sdkConfiguration) *NovuPreferences {
	return &NovuPreferences{
...
func (s *NovuPreferences) Retrieve(ctx context.Context, subscriberID string, idempotencyKey *string, opts ...operations.Option) (*operations.SubscribersControllerGetSubscriberPreferencesResponse, error) {
...
// Update subscriber global or workflow specific preferences
func (s *NovuPreferences) Update(ctx context.Context, subscriberID string, patchSubscriberPreferencesDto components.PatchSubscriberPreferencesDto, idempotencyKey *string, opts ...operations.Option) (*operations.SubscribersControllerUpdateSubscriberPreferencesResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
