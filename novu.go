...
// Generated from OpenAPI doc version 2.3.0 and generator version 2.648.7
...
func New(opts ...SDKOption) *Novu {
	sdk := &Novu{
		SDKVersion: "1.4.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.4.0 2.648.7 2.3.0 github.com/novuhq/novu-go",
...
func (s *Novu) Retrieve(ctx context.Context, request operations.LogsControllerGetLogsRequest, opts ...operations.Option) (*operations.LogsControllerGetLogsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/v1/logs/requests")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.LogsControllerGetLogsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.LogsControllerGetLogsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
