...
// Generated from OpenAPI doc version 3.19.2 and generator version 2.937.18
...
func New(opts ...SDKOption) *Novu {
	sdk := &Novu{
		SDKVersion: "3.20.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:         "speakeasy-sdk/go 3.20.0 2.937.18 3.19.2 github.com/novuhq/novu-go/v3",
			SDKVersion:        "3.20.0",
			GenVersion:        "2.937.18",
	...
	sdk.Contexts = newContexts(sdk, sdk.sdkConfiguration, sdk.hooks)
