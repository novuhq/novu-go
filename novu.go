...
func New(opts ...SDKOption) *Novu {
	sdk := &Novu{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.0.12",
			GenVersion:        "2.496.0",
			UserAgent:         "speakeasy-sdk/go 0.0.12 2.496.0 1.0 github.com/novuhq/novu-go",
			Hooks:             hooks.New(),
		},
	}
	...
	sdk.Support = newSupport(sdk.sdkConfiguration)
...
func (s *Novu) Trigger(ctx context.Context, request components.TriggerEventRequestDto, opts ...operations.Option) (*operations.EventsControllerTriggerResponse, error) {
...
func (s *Novu) TriggerBulk(ctx context.Context, request components.BulkTriggerEventDto, opts ...operations.Option) (*operations.EventsControllerTriggerBulkResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Novu) Broadcast(ctx context.Context, request components.TriggerEventToAllRequestDto, opts ...operations.Option) (*operations.EventsControllerBroadcastEventToAllResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Novu) Cancel(ctx context.Context, transactionID string, opts ...operations.Option) (*operations.EventsControllerCancelResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
