...
// Generated from OpenAPI doc version 2.3.0 and generator version 2.675.0
...
func New(opts ...SDKOption) *Novu {
	sdk := &Novu{
		SDKVersion: "1.4.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.4.0 2.675.0 2.3.0 github.com/novuhq/novu-go",
...
func (s *Novu) Retrieve(ctx context.Context, request operations.ActivityControllerGetLogsRequest, opts ...operations.Option) (*operations.ActivityControllerGetLogsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v1/activity/requests")
	if err != nil {
	...
	res := &operations.ActivityControllerGetLogsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetRequestsResponseDto
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetRequestsResponseDto = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
