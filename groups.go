...
func newGroups(rootSDK *Novu, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Groups {
	return &Groups{
		rootSDK:          rootSDK,
...
func (s *Groups) Delete(ctx context.Context, resourceType operations.ResourceType, resourceID string, idempotencyKey *string, opts ...operations.Option) (*operations.TranslationControllerDeleteTranslationGroupEndpointResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/translations/{resourceType}/{resourceId}", request, nil)
	if err != nil {
	...
	res := &operations.TranslationControllerDeleteTranslationGroupEndpointResponse{
...
func (s *Groups) Retrieve(ctx context.Context, resourceType operations.TranslationControllerGetTranslationGroupEndpointPathParamResourceType, resourceID string, idempotencyKey *string, opts ...operations.Option) (*operations.TranslationControllerGetTranslationGroupEndpointResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/translations/group/{resourceType}/{resourceId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.TranslationControllerGetTranslationGroupEndpointResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.TranslationGroupDto
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.TranslationGroupDto = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
