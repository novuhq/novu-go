...
func (s *Subscriptions) Update(ctx context.Context, topicKey string, subscriptionID string, updateTopicSubscriptionRequestDto components.UpdateTopicSubscriptionRequestDto, idempotencyKey *string, opts ...operations.Option) (*operations.TopicsControllerUpdateTopicSubscriptionResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/topics/{topicKey}/subscriptions/{subscriptionId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
