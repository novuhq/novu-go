...
func (s *Subscriptions) Create(ctx context.Context, topicKey string, createTopicSubscriptionsRequestDto components.CreateTopicSubscriptionsRequestDto, idempotencyKey *string, opts ...operations.Option) (*operations.TopicsControllerCreateTopicSubscriptionsResponse, error) {
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CreateSubscriptionsResponseDto
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.CreateSubscriptionsResponseDto = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Subscriptions) GetSubscription(ctx context.Context, topicKey string, identifier string, idempotencyKey *string, opts ...operations.Option) (*operations.TopicsControllerGetTopicSubscriptionResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v2/topics/{topicKey}/subscriptions/{identifier}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.TopicsControllerGetTopicSubscriptionResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Subscriptions) Update(ctx context.Context, topicKey string, identifier string, updateTopicSubscriptionRequestDto components.UpdateTopicSubscriptionRequestDto, idempotencyKey *string, opts ...operations.Option) (*operations.TopicsControllerUpdateTopicSubscriptionResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "UpdateTopicSubscriptionRequestDto", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.TopicsControllerUpdateTopicSubscriptionResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
