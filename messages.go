...
func (s *Messages) Delete(ctx context.Context, messageID string, opts ...operations.Option) (*operations.MessagesControllerDeleteMessageResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Messages) DeleteByTransactionID(ctx context.Context, transactionID string, channel *operations.Channel, opts ...operations.Option) (*operations.MessagesControllerDeleteMessagesByTransactionIDResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
