...
type NovuSubscribersNotifications struct {
	sdkConfiguration sdkConfiguration
}

func newNovuSubscribersNotifications(sdkConfig sdkConfiguration) *NovuSubscribersNotifications {
	return &NovuSubscribersNotifications{
